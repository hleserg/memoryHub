...
Подробная архитектура → [`docs/architecture/SYSTEM-ru.md`](docs/architecture/SYSTEM-ru.md) · Манифест → [`MANIFEST-ru.md`](MANIFEST-ru.md) · Стандарт разработки → [`docs/development/DEVELOPMENT_STANDARD.md`](docs/development/DEVELOPMENT_STANDARD.md)
